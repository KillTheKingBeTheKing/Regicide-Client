...
public final class ObjectDefinition {
	...
	public static ObjectDefinition lookup(int id) {
		...
		if (id == 6943) {
			objectDef.isInteractive = true;
			objectDef.interactions = new String[5];
			objectDef.interactions[0] = "Open";
			objectDef.name = "Regicide bank booth";
		}
	...
	public Model model(int j, int k, int l) {
		...
		/*
		 * if (modifiedTexture != null) { for (int k2 = 0; k2 < modifiedTexture.length;
		 * k2++) model_3.retexture(modifiedTexture[k2], originalTexture[k2], -1); }
		 */
		if (flag)
