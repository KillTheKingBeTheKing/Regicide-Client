...
public class AppdataDownloader {
	...
	private enum FileType {
		...
		FileType(String cacheDir, String localName, String serverName, String downloadName) {
			...
			this.url = "http://OSRSps.com/ClientFiles/appdata/";
		}
	...
	public static String getNewestVersion(FileType type) {
		String md5 = null;
		try (InputStream input = new URL("http://OSRSps.com/ClientFiles/appdata/appdata.php?file=" + type.getServerFilename()).openStream()) {
