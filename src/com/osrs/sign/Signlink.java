...
public final class Signlink implements Runnable {
    ...
    public static String getDataDirectory() {
        ...
        if (OSValidator.isWindows()) {
            cacheDirectory = new File(System.getenv("AppData") + File.separator + "osrs");
            dir = System.getenv("AppData") + File.separator + "osrs";
        } else {
            cacheDirectory = new File(System.getenv("user.home") + File.separator + "Library" + File.separator + "Application Support" + File.separator + "osrs");
            dir = System.getenv("user.home") + File.separator + "Library" + File.separator + "Application Support" + File.separator + "osrs";
        }
