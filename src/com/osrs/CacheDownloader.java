...
public class CacheDownloader {
	...
	private enum FileType {
		...
		FileType(String cacheDir, String localName, String serverName, String downloadName) {
			...
			this.url = "https://eq-rsps.io/public/downloads/OSRS/cache/";
		}
	...
	public static String getNewestVersion(FileType type) {
		String md5 = null;
		try (InputStream input = new URL("https://eq-rsps.io/public/downloads/OSRS/cache/cache.php?file=" + type.getServerFilename()).openStream()) {
	...
	public static void populateNewestVersions() {
		String[] md5 = null;
		try (InputStream input = new URL("https://eq-rsps.io/public/downloads/OSRS/cache/cache_all.php").openStream()) {
