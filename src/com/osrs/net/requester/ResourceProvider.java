...
import com.osrs.collection.Queue;
import com.osrs.io.Buffer;
import com.osrs.io.jaggrab.JagGrabConstants;
...
public final class ResourceProvider extends Provider implements Runnable {
    ...
    public void initialize(FileArchive archive, Client client) {
        ...
        System.err.println("[OSRS] Loaded: " + file_amounts[3] + " maps");
        ...
        System.err.println("[OSRS] Loaded: " + file_amounts[2] + " sounds");
        ...
        System.err.println("[OSRS] Loaded: " + file_amounts[0] + " models");
