...
public final class Configuration {
	...
	public static String SERVER_ADDRESS = "162.252.11.146"; // 162.252.11.146 localhost
	 ...
	 */
	public static final String CLIENT_NAME = "Regicide";
	...
	/**
	 * Used to merge all the OS Buddy XP Drops so the counter doesn't get too big if
	 * you are training a lot of different skills
	 */
	...
	/**
	 * Should it always be a left click to attack a player, no matter if they are
	 * higher combat level than us?
	 */
