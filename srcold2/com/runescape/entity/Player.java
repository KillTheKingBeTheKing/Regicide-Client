	...
	public Model getRotatedModel() {
		...
		if (super.graphic != -1 && super.currentAnimation != -1) {
			...
			if (spotAnimationModel  != null) {
				...
				int nextFrame = spotAnim.aAnimation_407.primaryFrames[super.nextGraphicsAnimationFrame];
				int cycle1 = spotAnim.aAnimation_407.durations[super.currentAnimation];
				...
				if (spotAnim.resizeX != 128 || spotAnim.resizeY != 128)
					model_3.scale(spotAnim.resizeX, spotAnim.resizeX, spotAnim.resizeY);
