...
public final class Widget {
	...
	public static void fKeys(GameFont[] tda) {
		...
		for (int tab = 0, button = f_keys_bg_start; tab < 14; tab++, button += 3) {
			...
			interfaceCache[button].actions = new String[] { "@or1@F1", "@or1@F2", "@or1@F3", "@or1@F4", "@or1@F5",
					"@or1@F6", "@or1@F7", "@or1@F8", "@or1@F9", "@or1@F10", "@or1@F11", "@or1@F12", "@or1@ESC" };
	...
	public static void settingsTab() {
		...
		addButton(42511, 42500, 40, 40, interfaceCache[19156].disabledSprite, interfaceCache[19156].enabledSprite, -1,
				"More Settings");
	...
	public static void monsters(GameFont[] t) {
		...
		String[] tooltips = { "Teleport: Rock Crabs", "Teleport: Pack Yaks", "Teleport: Experiments",
				"Teleport: Zombies", "Teleport: Bandits", "Teleport: Rock Crab", "Teleport: Rock Crab",
				"Teleport: Rock Crab", "Teleport: Rock Crab" };
		...
		for (int i = 0, counter = 0, yDraw = 0; i < tooltips.length; i++, frame += 4, frameHover += 4, counter++, index += 2) {
			...
			addHoveredButtonWTooltip(frameHover, sprites[index + 1], sprite_w, sprite_h, frameHover + 1, frameHover + 2,
					s, hoverXOffset, hoverYOffset);
	...
	public static void wilderness(GameFont[] t) {
		...
		// Add all monsters into the scroll..
		String[] tooltips = { "Ditch", "West Dragons", "Obelisk", "Graveyard", "Bandit Camp @red@(Multi)",
				"Hunter Hill", "Demonic Ruins @red@(Multi)", "Runite Rocks", "The Gate", "Target Teleport" };
		int[] sprites = { 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 452,
				453 };
		int sprite_w = 65;
		int sprite_h = 54;
		int index = 0;
	...
	public static void constructLunar() {
		...
		// NOTE: Lunar Teleports have been removed from the spellbook (the ones that are
		// commented out are teleports)
